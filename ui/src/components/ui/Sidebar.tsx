...
const SidebarLink = ({ children, isActive, icon, notifications, href }) => {
  const Icon = icon
  return (
      <Link
      to={href} 
      className={cx(
        "w-full flex items-center justify-between rounded-md p-2 text-base transition hover:bg-gray-200/50 sm:text-sm hover:dark:bg-gray-900",
